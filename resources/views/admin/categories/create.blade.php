    ...
    <div class="row">
        <div class="row" style="background-color: #6D4C35;padding:2% 0% 2%">
            ...
            <div class="col-8 text-white">
                <p class="h3">Nueva Categoria</p>
            </div>
        </div>
        <div class="row justify-content-md-center" style="background-color: #C19A6B;padding: 1% 0% 2%">
            <div class="col-8">
                <form action="{{route('admin.categories.store',$user)}}" method="post">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="description" style="resize: none" rows="5">{{@old('description')}}</textarea>
