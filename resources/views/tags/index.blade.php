                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <blockquote class="blockquote mb-0">
                                <p>{{ $tag->description }}</p>
                                <footer class="blockquote-footer">Esta etiqueta tiene: {{ $tag->products->count() }}
                                    productos</footer>
                                <a href=" {{ route('visitor.tags.show', ['user'=>$user,'tag'=>$tag->id]) }} " class="btn btn-danger">Ver Productos</a>
                            </blockquote>
                        </div>
                    </div>
                </div>
